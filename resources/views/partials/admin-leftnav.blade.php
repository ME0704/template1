...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="admin.blade.php"><img src="admin-assets/images/logo.svg" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="admin.blade.php"><img src="admin-assets/images/logo-mini.svg" alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="/admin/suppliers">
                ...
                <span class="menu-title">Suppliers Dashboard</span>
            </a>
        </li>
        <li class="nav-item menu-items">
